...
const OPTIONAL_SECRETS_BY_ARN_KEY = new Map([
  ...
  ["OPENSEND_API_KEY_SECRET_ARN", "OPENSEND_API_KEY"],
  ["R2_ACCESS_KEY_ID_SECRET_ARN", "AWS_ACCESS_KEY_ID"],
  ["R2_SECRET_ACCESS_KEY_SECRET_ARN", "AWS_SECRET_ACCESS_KEY"],
]);
...
const OPTIONAL_ENV_VARS_BY_KEY = new Map([
  ...
  ["OPENSEND_BASE_URL", "OPENSEND_BASE_URL"],
]);
