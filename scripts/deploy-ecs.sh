...
for name in \
  ...
  METRICS_TOKEN_SECRET_ARN STRIPE_WEBHOOK_SIGNING_SECRET_SECRET_ARN STRIPE_SECRET_KEY_SECRET_ARN \
  STRIPE_CLOUD_TEAM_PRICE_ID STRIPE_CLOUD_BUSINESS_PRICE_ID \
