...
# create_worktree.sh - Create a new git worktree for exponential development.
#
# Usage:
...
# EXPONENTIAL_WORKTREE_OVERRIDE_BASE.
#
...
if [ -n "${EXPONENTIAL_WORKTREE_OVERRIDE_BASE:-}" ]; then
    WORKTREES_BASE="${EXPONENTIAL_WORKTREE_OVERRIDE_BASE}/${REPO_BASE_NAME}"
else
