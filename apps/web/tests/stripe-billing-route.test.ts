...
import { POST as webhookPost } from "./legacy-api/stripe/webhook/route";
import { POST as checkoutPost } from "./legacy-api/workspaces/current/billing/checkout/route";
import { POST as portalPost } from "./legacy-api/workspaces/current/billing/portal/route";
