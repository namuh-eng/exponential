...
export function InitiativesClient({
  ...
  initialData: InitiativesResponse | null;
}) {
  const [data, setData] = useState<InitiativesResponse | null>(initialData);
  ...
  // mount fetch when it is present. Subsequent runs refetch normally to stay live.
