...
export function headlessInitiativesEnabled() {
  return process.env.EXPONENTIAL_HEADLESS_INITIATIVES === "true";
}
...
export function createHeadlessInitiativesClient(token: string) {
  return createHeadlessClient(token);
}
